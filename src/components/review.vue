<template>
    ...
    <el-table-column
      ...
      <template slot-scope="scope">
         <el-span>{{ scope.row.user.nickname }}</el-span>
      </template>
    </el-table-column>
     <el-table-column
      label="评论内容"
    ...
    methods: {
      init(){
          ...
          search(val) {
            ...
            request.get('/review/list?key='+this.query.key+
          ...
          del(index, row) {
            ...
            update(index,row){
              this.$router.push({path:'/review/add',query:row});
              console.log(row)
          ...
          add(){
            this.$router.push({path:'/review/add'})
          },
          handleEdit(v,row){
            this.$router.push({path:'/review/add',query:row})
          },
